            ...
            <ScrollView className='px-4 my-6'>
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    <TouchableOpacity onPress={() => openPicker('video')}>
                        {form.video ? (
                            <WebView
                                source={{ uri: form.video.uri }} // Use the Vimeo video ID
                                style={{ width: '350', height: 300, resizeMode: 'contain', flex: 1 }}
                                javaScriptEnabled
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    <TouchableOpacity onPress={() => openPicker('image')}>
                        {form.thumbnail ? (
                            ...
                            <Image source={{ uri: form?.thumbnail?.uri }} resizeMode='cover' className='w-5 h-5' />
